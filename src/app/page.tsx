...
import { FrameworRotation } from "@/components/framework-rotation";
...
export default function Home() {
  ...
  return (
    <main>
      ...
      <div
        className={cn(
          "bg-black fixed inset-0 transition-opacity-[1500ms]",
        ...
        <div className="flex flex-col items-center relative z-10">
          ...
          >
            <Image
              ...
              height={50}
            />
            to <FrameworRotation currentFramework={currentFramework} /> will{" "}
            <span
